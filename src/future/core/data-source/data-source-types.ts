...
import { DataSourceOptions, DriverType } from "./data-source-options-types";

export type AnyDataSource = DataSource<
  DataSourceOptions<DriverType, EntityMap>
  >;
...
export type DataSource<
  Options extends DataSourceOptions<DriverType, EntityMap>
  > = {
  "@type": "DataSource";
  options: Options;
