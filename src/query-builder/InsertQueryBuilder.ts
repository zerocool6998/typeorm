...
export class InsertQueryBuilder<Entity> extends QueryBuilder<Entity> {
    ...
    protected createInsertExpression() {
        ...
        const returningExpression =
            (this.connection.driver.options.type === "oracle" && this.getValueSets().length > 1)
                ? null
        ...
        if (columnsExpression) {
            ...
            if (!valuesExpression && (DriverUtils.isMySQLFamily(this.connection.driver) || this.connection.driver.options.type === "aurora-data-api")) // special syntax for mysql DEFAULT VALUES insertion
                query += "()";
        }
        ...
        if (valuesExpression) {
            ...
            if (DriverUtils.isMySQLFamily(this.connection.driver) || this.connection.driver.options.type === "aurora-data-api") { // special syntax for mysql DEFAULT VALUES insertion
                query += " VALUES ()";
            } else {
        ...
        if (this.connection.driver.supportedUpsertType === "on-conflict-do-update") {
            if (this.expressionMap.onIgnore) {
                ...
                if (Array.isArray(overwrite) && skipUpdateIfNoValuesChanged && this.connection.driver.options.type === "postgres") {
                    query += ` WHERE (`;
            ...
            valueSets.forEach((valueSet, valueSetIndex) => {
                columns.forEach((column, columnIndex) => {
                    ...
                    // if column is generated uuid and database does not support its generation and custom generated value was not provided by a user - we generate a new uuid value for insertion
                        ...
                        if ((this.connection.driver.options.type === "oracle" && valueSets.length > 1) || DriverUtils.isSQLiteFamily(this.connection.driver) || this.connection.driver.options.type === "sap") { // unfortunately sqlite does not support DEFAULT expression in INSERT queries
            ...
            valueSets.forEach((valueSet, insertionIndex) => {
                ...
                columns.forEach((columnName, columnIndex) => {
                    ...
                    // if value for this column was not provided then insert default value
                        ...
                        if (DriverUtils.isSQLiteFamily(this.connection.driver) || this.connection.driver.options.type === "sap") {
                            expression += "NULL";
